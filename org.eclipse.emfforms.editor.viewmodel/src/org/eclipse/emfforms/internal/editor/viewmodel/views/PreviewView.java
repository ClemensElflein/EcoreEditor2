...
package org.eclipse.emfforms.internal.editor.viewmodel.views;
...
public class PreviewView extends ViewPart implements ISelectionListener {
	...
	private Composite getPageHeader(Composite parent) {
		...
		final ImageDescriptor imageDescriptor = ImageDescriptor.createFromURL(FrameworkUtil.getBundle(this.getClass())
	...
	private void addButtonsToFormToolbar(IToolBarManager toolBarManager) {
		...
		automaticToggleButton.setImageDescriptor(ImageDescriptor.createFromURL(FrameworkUtil.getBundle(this.getClass())
		...
		manualRefreshButton.setImageDescriptor(ImageDescriptor.createFromURL(FrameworkUtil.getBundle(this.getClass())
		...
		loadDataButton.setImageDescriptor(ImageDescriptor.createFromURL(FrameworkUtil.getBundle(this.getClass())
		...
		cleanDataButton.setImageDescriptor(ImageDescriptor.createFromURL(FrameworkUtil.getBundle(this.getClass())
